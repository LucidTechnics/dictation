  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "hasPropertiesFrom": parse_hasPropertiesFrom,
        "ancestorList": parse_ancestorList,
        "ancestor": parse_ancestor,
        "isAbstract": parse_isAbstract,
        "resourceName": parse_resourceName,
        "securityStatements": parse_securityStatements,
        "securityStatement": parse_securityStatement,
        "actionList": parse_actionList,
        "action": parse_action,
        "roleList": parse_roleList,
        "role": parse_role,
        ...
        "isNot": parse_isNot,
        "has": parse_has,
        "isNotRequired": parse_isNotRequired,
      ...
      function parse_resource() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result2 = (function(offset, resourceName) { resource = { securityMap: {view: {all: 1}, collect: { all: 1}, create: {all: 1}, update: {all: 1}, delete: {noone: 1}}, ancestorList: [], attributeList:[] }; resource.name = resourceName.join('');
            ...
            if (result2 !== null) {
              result3 = parse_isAbstract();
              if (result3 === null) {
                result3 = parse_hasPropertiesFrom();
              }
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  result5 = parse_securityStatements();
      ...
      function parse_hasPropertiesFrom() {
        var result0, result1;
        var pos0;
        
        pos0 = pos;
        if (input.substr(pos, 20) === " has properties from") {
      ...
      function parse_ancestor() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result1 = (function(offset, ancestor) {resource.ancestorList.push(ancestor.join(''));})(pos1, result1);
          }
          if (result1 === null) {
            pos = pos1;
          }
      ...
      function parse_isAbstract() {
        var result0;
        var pos0;
        
        pos0 = pos;
        if (input.substr(pos, 12) === " is abstract") {
          result0 = " is abstract";
          pos += 12;
        } else {
          result0 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, isAbstract) { resource.isAbstract = true; })(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_securityStatements() {
        var result0, result1;
        
        result1 = parse_securityStatement();
        if (result1 !== null) {
          result0 = [];
          while (result1 !== null) {
            result0.push(result1);
      ...
      function parse_securityStatement() {
        var result0, result1, result2, result3;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result0 = (function(offset, canBe) {actionList = []; })(pos1, result0);
        }
        if (result0 === null) {
          pos = pos1;
        }
        if (result0 !== null) {
          result1 = parse_actionList();
          if (result1 !== null) {
      ...
      function parse_action() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            if (input.substr(pos, 9) === "collected") {
              result0 = "collected";
              pos += 9;
            } else {
              result0 = null;
              if (reportFailures === 0) {
                matchFailed("\"collected\"");
              }
            }
            if (result0 === null) {
              ...
              if (result0 === null) {
                ...
                if (result0 === null) {
                  ...
                  if (result0 === null) {
                    if (input.substr(pos, 9) === "destroyed") {
                      result0 = "destroyed";
                      pos += 9;
                    } else {
                      result0 = null;
                      if (reportFailures === 0) {
                        matchFailed("\"destroyed\"");
                      }
                    }
                  }
                }
        ...
        if (result0 !== null) {
          result0 = (function(offset, actionName) {
      ...
      function parse_roleName() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, roleName) { actionList.forEach(function(_action)
          {   
      ...
      function parse_isNotRequired() {
        var result0;
        var pos0;
        
        pos0 = pos;
        if (input.substr(pos, 15) === "is not required") {
          result0 = "is not required";
          pos += 15;
        } else {
          result0 = null;
          if (reportFailures === 0) {
            matchFailed("\"is not required\"");
          }
        }
        if (result0 !== null) {
          result0 = (function(offset) { attribute.featureMap['required'] = false; })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_type() {
        ...
        if (result0 !== null) {
          ...
          result1 = parse_value();
          if (result1 !== null) {
            result1 = (function(offset, type) {attribute.featureMap['type'] = type.join(''); })(pos1, result1);
          }
          if (result1 === null) {
            pos = pos1;
          }
